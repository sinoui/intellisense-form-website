...
<BundleList version="1.13.4" frontend="1.13.4" backend="1.13.3" font="1.13.0" />

## 2. 平滑升级

可以从任何版本平滑升级到 v1.13.4。
...
- fix(comp-role-manager): 修复角色授权接口参数丢失的 bug
- feat(comp-custom-search-page-config): 支持查询列表查询条件定制
- feat(comp-custom-search-page-config): 支持查询列表列表展示项定制
