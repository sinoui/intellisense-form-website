...
<BundleList version="1.14.5" frontend="1.14.5" backend="1.14.5" font="1.13.0" />

## 2. 平滑升级

可以从任何版本平滑升级到 v1.14.5。
...
- fix: 修复表单设计中 选择框关联其他表单数据时，按选项值排序报错的问题
- fix: 导出 excel 功能，在没有任何查询条件的情况下导出失败
- fix: 修复文件上传，文件类型为非全部时，安卓手机点击文件选择，提示没有应用可执行此操作。[缺陷链接](https://gitee.com/sinoui/sino-intellisense-form-test/issues/I4VQVL)
