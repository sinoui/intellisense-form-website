...
<BundleList version="1.14.2" frontend="1.14.1" backend="1.14.2" font="1.13.0" />

## 2. 平滑升级

可以从任何版本平滑升级到 v1.14.2。
...
- fix: 修复 1.14.1 版本中缺少 user_name 和 dept_name 字段的问题
