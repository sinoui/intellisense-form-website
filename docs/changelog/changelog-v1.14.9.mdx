...
<BundleList version="1.14.9" frontend="1.14.9" backend="1.14.9" font="1.13.0" />

## 2. 平滑升级

可以从任何版本平滑升级到 v1.14.9。
...
- fix: 修复部门管理员如果设置的是子级部门的话，管理员登录之后没有查询列表资源的 bug
