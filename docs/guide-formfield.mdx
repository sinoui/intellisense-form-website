...
本章节得示例代码可以在[Web Component 插件示例项目](https://gitee.com/sinoui/sinoform-plugins-web-component-examples/tree/master/src/plugins/form-field-custom-textinput)中找到。

:::

## Web Components 方式开发

以 render 组件为例，在 plugins/form-field-custom-textinput 下创建`InputRenderer.ts`文件
