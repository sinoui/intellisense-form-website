...
#依赖的系统服务
url:
  workflowDesignUrl: http://192.168.80.142:8080/workflowDesign #工作流设计器路径
  workflowUrl: http://192.168.80.142:18003/workflow #工作流引擎路径
  uiasUrl: http://192.168.80.142:18001/uias #统一授权管理系统路径
  resourceUrl: http://192.168.80.142:18001/uias #资源路径
  syncWorkflowItemsUrl: http://192.168.80.142:18001/uias #同步工作流待办已办接口
```
